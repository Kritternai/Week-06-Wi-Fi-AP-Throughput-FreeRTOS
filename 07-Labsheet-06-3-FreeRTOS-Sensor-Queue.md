...
> **ตอบ:** เพราะ FreeRTOS Queue มีกลไกจัดการ Critical Section อยู่เบื้องหลัง ทำให้มั่นใจได้ว่าขณะที่ Task หนึ่งกำลังเขียนข้อมูล อีก Task จะไม่สามารถเข้ามาอ่านข้อมูลที่ยังเขียนไม่เสร็จได้ (ป้องกัน Data Corruption และ Race Condition) ในขณะที่ตัวแปร Global ปกติไม่มีกลไกนี้ป้องกัน
